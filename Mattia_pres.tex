...
\begin{document}
	...
	\begin{frame}{Dataset}
		...
		\begin{itemize}
			...
			\item In particular, we consider 200 images from the resized test set, where the images have been resized to $256 * 256$ regardless of the original aspect ratio.
	...
	\begin{frame}{Qualitative Results}
			...
			\begin{column}{0.65\textwidth}
				\centering
				\includegraphics[height=0.8\textheight, width=0.8\linewidth]{images/PConvQResults.png}
			\end{column}
	...
	\begin{frame}{Qualitative Results}
			...
			\begin{column}{0.65\textwidth}
				\centering
				\includegraphics[height=0.8\textheight, width=0.8\linewidth]{images/PAttentionQResults.png}
			\end{column}
